(() => {
  ...
  // dots, thin verticals, then letters/digits, a heavier bracket, and
  // finally parens/slashes as the densest. Plain ASCII only - the box-
  // drawing/math-symbol characters tried earlier weren't reliably the
